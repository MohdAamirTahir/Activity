...
<body>
			...
			<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
	  		...
	  		<div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="login.php" style="border-bottom: 3px solid #77b300; font-size: 17px;">LOGIN</a></li>
	...
	if(isset($_POST['sub']))
        ...
        if($con){
		   $email=$_POST['email'];
		   $pass=$_POST['pass'];
           $q="select * from assigntb  where email='$email' and pass=$pass";
           $query=mysqli_query($con,$q);
		   if(mysqli_num_rows($query)>0){
			 //echo '<script>alert("Login successfully");</script>';
		    echo "<meta http-equiv='refresh' content='0'>";
	        setcookie("cname",$email,time()+200);
